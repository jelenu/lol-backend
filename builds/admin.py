...
from .models import Item, Stat, ItemStat, Tag, RuneSlot, RunePath
...
@admin.register(RuneSlot)
class RuneSlotAdmin(admin.ModelAdmin):
    list_display = ['key', 'name', 'slot_number', 'rune_path']